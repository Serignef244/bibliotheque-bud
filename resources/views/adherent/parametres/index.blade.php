...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="font-poppins text-3xl font-semibold text-slate-900 tracking-tight">Paramètres</h1>
    ...
    <div class="bg-white rounded-[2rem] shadow-sm border border-slate-200/60 overflow-hidden">
        ...
        <div class="p-8 space-y-10">
            ...
            <!-- Apparence -->
            <section>
                <h3 class="font-poppins text-xl font-semibold text-slate-900 mb-6">Apparence</h3>
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <label class="relative flex flex-col items-center gap-3 p-4 border-2 border-primary rounded-2xl cursor-pointer bg-slate-50/50">
                        ...
                        <span class="font-medium text-primary text-sm">Clair</span>
                    </label>
            ...
            <!-- Préférences -->
            <section>
                <h3 class="font-poppins text-xl font-semibold text-slate-900 mb-6">Préférences</h3>
                <div class="space-y-4">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-slate-50 rounded-2xl gap-4">
                        <div>
                        ...
                        <select class="w-full sm:w-auto bg-white border border-slate-200 text-slate-700 rounded-xl px-4 py-2 font-medium focus:ring-2 focus:ring-secondary focus:border-primary">
