...
<div class="relative overflow-hidden bg-slate-50 pt-16 pb-32 sm:pt-24 sm:pb-40">
    <div class="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 relative z-10 text-center">
        ...
        <h1 class="font-poppins text-5xl sm:text-7xl font-bold text-slate-900 tracking-tight leading-[1.1] mb-8 max-w-4xl mx-auto">
            La connaissance<br>
            <span class="italic text-primary">à portée de main.</span>
        </h1>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 sm:gap-8">
            ...
            <div class="text-center">
                <div class="w-16 h-16 bg-slate-50 text-primary rounded-2xl flex items-center justify-center mx-auto mb-6 transform -rotate-3">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                </div>
                <h3 class="font-poppins text-2xl font-bold text-slate-900 mb-3">Vaste catalogue</h3>
            ...
            <div class="text-center">
                ...
                <h3 class="font-poppins text-2xl font-bold text-slate-900 mb-3">Gestion simplifiée</h3>
            ...
            <div class="text-center">
                ...
                <h3 class="font-poppins text-2xl font-bold text-slate-900 mb-3">Alertes & Notifications</h3>
